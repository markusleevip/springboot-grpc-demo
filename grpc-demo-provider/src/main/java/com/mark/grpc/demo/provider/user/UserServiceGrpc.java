...
public final class UserServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.mark.grpc.demo.provider.user.UserService";
  ...
  public static io.grpc.MethodDescriptor<UserRequest,
      UserResponse> getGetUserMethod() {
    io.grpc.MethodDescriptor<UserRequest, UserResponse> getGetUserMethod;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_USER:
          serviceImpl.getUser((UserRequest) request,
              (io.grpc.stub.StreamObserver<UserResponse>) responseObserver);
          break;
        default:
